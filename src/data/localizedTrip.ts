...
const itineraryIt: LocalizedItineraryDay[] = [
  ...
  },
  {
    ...
    day: "Giovedi",
    plan: "Giornata culturale a Delhi: Tomba di Humayun, Lodhi Garden, blocco cibo/mercati Old Delhi limitato, India Gate.",
    transport: "Auto privata / blocco guidato in riscio a Old Delhi",
    travelTime: "Spostamenti locali 20-45 min ciascuno",
    connection: "Nessuna",
    pace: "Moderato",
    notes: "Dare priorita alla Tomba di Humayun e a Lodhi Garden; tenere Old Delhi breve, guidata e focalizzata su cibo/mercati.",
  },
  {
    ...itinerary[6],
