...
const itineraryIt: LocalizedItineraryDay[] = [
  ...
  },
  {
    ...
    day: "Venerdì",
    plan: "Agra Fort, Itimad-ud-Daulah, poi Mehtab Bagh per vedere il Taj al tramonto dall'altra sponda del fiume.",
    transport: "Auto privata con guida / brevi passeggiate",
    travelTime: "Spostamenti locali 15-40 min ciascuno",
    connection: "Nessuna",
    pace: "Moderato",
    notes: "Il Taj Mahal è chiuso ai turisti ogni venerdì. Usare questa giornata per gli altri monumenti di Agra, che restano aperti.",
  },
  {
    ...itinerary[6],
    date: "14 novembre 2026",
    day: "Sabato",
    plan: "Taj Mahal all'alba, rientro per colazione e check-out, poi viaggio in auto con la guida fino a Rishikesh.",
    transport: "Auto privata con guida",
    travelTime: "Visita del Taj all'alba, poi circa 6-7h di guida più soste comode",
    connection: "Nessuna",
    pace: "Giorno di viaggio",
    notes: "Il Taj è aperto sabato. Prenotare il primo ingresso e prevedere un arrivo più tardi a Rishikesh.",
  },
  {
    ...itinerary[7],
