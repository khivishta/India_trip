...
export const itinerary: ItineraryDay[] = [
  ...
  },
  {
    ...
    baseCity: "Delhi",
    sleepIn: "Delhi",
    plan: "Delhi culture day: Humayun's Tomb, Lodhi Garden, bounded Old Delhi food/market block, India Gate.",
    transport: "Private car / guided Old Delhi rickshaw block",
    transportKind: "car",
    travelTime: "Local drives 20-45m each",
    connection: "None",
    pace: "Moderate",
    notes: "Prioritize Humayun's Tomb and Lodhi Garden; keep Old Delhi short, guided, and food/market focused.",
  },
  {
    date: "Oct 30, 2026",
    day: "Friday",
