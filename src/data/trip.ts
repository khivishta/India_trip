...
export const tripStats = {
  ...
  route: "Mumbai -> Ellora -> Udaipur -> Jaipur -> Agra -> Delhi -> Rishikesh -> Dehradun Airport -> Mumbai",
  flights: 2,
  privateDrives: 5,
...
export const itinerary: ItineraryDay[] = [
  ...
  },
  {
    ...
    connection: "Direct premium train; faster than the typical 7-8h drive",
    pace: "Travel Day",
    notes: "Vande Bharat is recommended because its current 5h30 timetable beats the typical 7-8h drive. Do not squeeze Ellora into arrival day.",
  },
  {
    date: "Nov 11, 2026",
    day: "Wednesday",
...
export const routeLegs: RouteLeg[] = [
  ...
  },
  {
    ...
    notes: "Book Executive Chair Car or Chair Car; confirm Nov 10 timing when reservations open. The current 5h30 timetable beats the typical 7-8h drive.",
