...
export const itinerary: ItineraryDay[] = [
  ...
  },
  {
    ...
    baseCity: "Agra",
    sleepIn: "Agra",
    plan: "Taj Mahal sunrise, Agra Fort, then Mehtab Bagh or a relaxed Taj sunset viewpoint.",
    transport: "Private guide car / short walks",
    transportKind: "car",
    travelTime: "Local drives 15-40m each",
    connection: "None",
    pace: "Moderate",
    notes: "A second Agra night keeps the Taj day relaxed.",
  },
  {
    date: "Nov 14, 2026",
    day: "Saturday",
    ...
    sleepIn: "Rishikesh",
    plan: "Drive with the guide to Rishikesh. Take comfort stops and keep the evening unscheduled.",
    transport: "Private guide car",
    transportKind: "car",
    travelTime: "About 6-7h plus comfort stops",
    connection: "None",
    pace: "Travel Day",
    notes: "Within the 6-8 hour driving limit and avoids an extra flight.",
  },
  {
    date: "Nov 15, 2026",
    day: "Sunday",
