...
export const uiText = {
  en: {
    ...
    galleryTitle: "Quick visual read of the trip",
  ...
  it: {
    ...
    rishikeshCallout:
      "Rishikesh e inclusa dal 2 al 4 novembre, con una giornata intera sul Ganga e ai piedi dell'Himalaya prima di proseguire verso Udaipur.",
    itineraryEyebrow: "Programma giorno per giorno",
    itineraryTitle: "Date, citta dove si dorme, trasporti e note di comfort",
    sleepIn: "Si dorme a",
    flight: "Volo",
    ...
    routeCheckIntro:
      "La tratta da Rishikesh/Dehradun a Udaipur e l'unico punto delicato: prenotare solo una coincidenza pulita sullo stesso biglietto.",
    dateHeader: "Data",
    ...
    statusHeader: "Stato",
    sourceFor: "Fonte per",
    galleryEyebrow: "Galleria visiva",
    galleryTitle: "Panoramica visiva rapida del viaggio",
    hotelsEyebrow: "Piano hotel",
    hotelsTitle: "Notti esatte per citta base",
    nightSingular: "notte",
    nightPlural: "notti",
  },
