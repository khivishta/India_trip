...
export const mustSeeByDate: Record<string, string> = {
  ...
  "Nov 11, 2026": "Ellora Caves, Kailasa Temple",
  "Nov 12, 2026": "One-stop flight to Agra; no added city stop",
  "Nov 13, 2026": "Taj Mahal sunrise, Agra Fort, Mehtab Bagh",
  "Nov 14, 2026": "Guide drive to Rishikesh",
...
export const mustSeeByDateIt: Record<string, string> = {
  ...
  "11 novembre 2026": "Grotte di Ellora, Tempio Kailasa",
  "12 novembre 2026": "Volo con una coincidenza per Agra; nessuna città aggiunta",
  "13 novembre 2026": "Taj Mahal all'alba, Agra Fort, Mehtab Bagh",
  "14 novembre 2026": "Viaggio con guida fino a Rishikesh",
...
export const transportSegments: TransportSegment[] = [
  ...
  },
  {
    ...
    category: "car",
    duration: "About 6-7h plus stops",
...
export const agencyTasks: AgencyTask[] = [
  ...
  { date: "Nov 11", city: "Aurangabad", pickup: "Aurangabad hotel", dropoff: "Ellora return", service: "Private car + Ellora guide", category: "vip", duration: "Full day", action: "Book guide focused on Kailasa Temple" },
  ...
  { date: "Nov 13", city: "Agra", pickup: "Agra hotel", dropoff: "Taj Mahal", service: "Taj sunrise VIP/guide/tickets", category: "vip", duration: "Early morning", action: "Book sunrise guide and required tickets" },
  { date: "Nov 13", city: "Agra", pickup: "Agra hotel", dropoff: "Agra Fort / Mehtab Bagh", service: "Private local car + guide", category: "vip", duration: "Half day", action: "Use the same guide after the Taj breakfast break" },
  { date: "Nov 14", city: "Agra / Rishikesh", pickup: "Agra hotel", dropoff: "Rishikesh hotel", service: "Private guide-driven car", category: "car", duration: "6-7h plus stops", action: "Use a comfortable vehicle; start early" },
