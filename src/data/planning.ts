...
export type TransportCategory = "flight-direct" | "flight-connection" | "train" | "car" | "taxi" | "boat" | "vip" | "optional";
...
const detailNotes: Partial<Record<string, Record<Language, string[]>>> = {
  ...
  "delhi:Humayun's Tomb": {
    en: [
      "Humayun's Tomb is the best Delhi monument for this route because it reveals the Mughal garden-tomb language also seen at the Taj Mahal. It is a garden tomb, a dynastic memorial and a lesson in Mughal symmetry.",
    ...
    it: [
      "La Tomba di Humayun è il monumento di Delhi più utile per questo itinerario perché rivela il linguaggio moghul della tomba-giardino visto anche al Taj Mahal. È tomba-giardino, memoria dinastica e lezione di simmetria moghul.",
  ...
  "rishikesh:Yoga / ashram time": {
    en: [
      ...
      "This is what makes the mountain stop restorative. It gives the family a different rhythm after Delhi and before the final flight to Mumbai, and justifies staying two nights instead of rushing through.",
    ],
    it: [
      ...
      "Questo rende la tappa di montagna rigenerante. Dà alla famiglia un ritmo diverso dopo Delhi e prima del volo finale per Mumbai, e giustifica due notti invece di attraversarla di fretta.",
    ],
  },
...
export const planningText = {
  en: {
    ...
    totalTrip: "12 nights in India / 13 hotel nights",
    nightsByPlace: "Hotel nights by place",
  ...
  it: {
    ...
    totalTrip: "12 notti in India / 13 notti in hotel",
    nightsByPlace: "Notti in hotel per luogo",
...
export const staySummaries: StaySummary[] = [
  { city: "Mumbai", checkIn: "Nov 8", checkOut: "Nov 10", nights: 2, color: "#0f4c81" },
  { city: "Aurangabad", checkIn: "Nov 10", checkOut: "Nov 12", nights: 2, color: "#755235" },
  { city: "Udaipur", checkIn: "Nov 12", checkOut: "Nov 14", nights: 2, color: "#1d4ed8" },
  { city: "Jaipur", checkIn: "Nov 14", checkOut: "Nov 16", nights: 2, color: "#be185d" },
  { city: "Agra", checkIn: "Nov 16", checkOut: "Nov 17", nights: 1, color: "#b91c1c" },
  { city: "Delhi", checkIn: "Nov 17", checkOut: "Nov 18", nights: 1, color: "#9333ea" },
  { city: "Rishikesh", checkIn: "Nov 18", checkOut: "Nov 20", nights: 2, color: "#19734f" },
  { city: "Mumbai", checkIn: "Nov 20", checkOut: "Nov 21", nights: 1, color: "#0f4c81" },
];

const staySummariesIt: StaySummary[] = [
  { city: "Mumbai", checkIn: "8 nov", checkOut: "10 nov", nights: 2, color: "#0f4c81" },
  { city: "Aurangabad", checkIn: "10 nov", checkOut: "12 nov", nights: 2, color: "#755235" },
  { city: "Udaipur", checkIn: "12 nov", checkOut: "14 nov", nights: 2, color: "#1d4ed8" },
  { city: "Jaipur", checkIn: "14 nov", checkOut: "16 nov", nights: 2, color: "#be185d" },
  { city: "Agra", checkIn: "16 nov", checkOut: "17 nov", nights: 1, color: "#b91c1c" },
  { city: "Delhi", checkIn: "17 nov", checkOut: "18 nov", nights: 1, color: "#9333ea" },
  { city: "Rishikesh", checkIn: "18 nov", checkOut: "20 nov", nights: 2, color: "#19734f" },
  { city: "Mumbai", checkIn: "20 nov", checkOut: "21 nov", nights: 1, color: "#0f4c81" },
];

export const mustSeeByDate: Record<string, string> = {
  "Nov 8, 2026": "Booked QR20 and QR556 journey via Doha",
  "Nov 9, 2026": "Arrival recovery, Marine Drive only if fresh",
  "Nov 10, 2026": "Optional Gateway of India / Colaba, then Vande Bharat 20706",
  "Nov 11, 2026": "Ellora Caves and Kailasa Temple — open Wednesday (closed Tuesday)",
  "Nov 12, 2026": "One-stop flight IXU -> BOM -> UDR; no self-transfer",
  "Nov 13, 2026": "City Palace, Lake Pichola, Jagdish Temple",
  "Nov 14, 2026": "Guide drive Udaipur -> Jaipur; car faster door-to-door than current train",
  "Nov 15, 2026": "Amber Fort, City Palace, Hawa Mahal",
  "Nov 16, 2026": "Guide drive Jaipur -> Agra; optional Fatehpur Sikri",
  "Nov 17, 2026": "Taj sunrise and Agra Fort, then Gatimaan Express to Delhi",
  "Nov 18, 2026": "Focused Delhi day, then Vande Bharat to Haridwar and car to Rishikesh",
  "Nov 19, 2026": "Ganga riverfront, Beatles Ashram, slow mountain/river day",
  "Nov 20, 2026": "Direct DED -> BOM flight, protected departure buffer",
  "Nov 21, 2026": "Booked 6E1303 and QR17 return via Doha",
};

export const mustSeeByDateIt: Record<string, string> = {
  "8 novembre 2026": "Viaggio prenotato QR20 e QR556 via Doha",
  "9 novembre 2026": "Recupero arrivo, Marine Drive solo se c'è energia",
  "10 novembre 2026": "Gateway of India / Colaba opzionali, poi Vande Bharat 20706",
  "11 novembre 2026": "Grotte di Ellora e Tempio Kailasa — aperti mercoledì (chiusi martedì)",
  "12 novembre 2026": "Volo IXU -> BOM -> UDR con uno scalo; niente self-transfer",
  "13 novembre 2026": "City Palace, Lake Pichola, Jagdish Temple",
  "14 novembre 2026": "Auto con guida Udaipur -> Jaipur; più rapida porta a porta del treno attuale",
  "15 novembre 2026": "Amber Fort, City Palace, Hawa Mahal",
  "16 novembre 2026": "Auto con guida Jaipur -> Agra; Fatehpur Sikri opzionale",
  "17 novembre 2026": "Taj all'alba e Agra Fort, poi Gatimaan Express per Delhi",
  "18 novembre 2026": "Giornata mirata a Delhi, poi Vande Bharat per Haridwar e auto per Rishikesh",
  "19 novembre 2026": "Ganga, Beatles Ashram, giornata lenta fiume/montagna",
  "20 novembre 2026": "Volo diretto DED -> BOM, cuscinetto partenza protetto",
  "21 novembre 2026": "Ritorno prenotato 6E1303 e QR17 via Doha",
};
...
export const transportSegments: TransportSegment[] = [
  ...
  },
  {
    ...
    from: "Mumbai hotel",
    to: "CSMT station",
    mode: "Private station transfer",
    category: "taxi",
    duration: "45-90m",
    status: "Traffic-sensitive transfer",
    action: "Leave a generous buffer before the train",
  },
  {
    date: "Nov 10",
    from: "Mumbai CSMT",
  ...
  {
    date: "Nov 12",
    from: "Aurangabad hotel",
    to: "Aurangabad airport (IXU)",
    mode: "Private airport transfer",
    category: "taxi",
    duration: "20-40m",
    status: "Short airport transfer",
    action: "Leave extra time for the domestic connection",
  },
  {
    date: "Nov 12",
    from: "Aurangabad (IXU)",
    to: "Udaipur (UDR) via Mumbai",
    mode: "One-stop flight",
    category: "flight-connection",
    duration: "Current airline guidance about 5h; exact winter schedule pending",
    status: "No nonstop; one-ticket connection required",
    evidence: "https://www.goindigo.in/domestic-flights/aurangabad-to-udaipur-flights.html",
    action: "Confirm the Nov 12 schedule; book IXU-BOM-UDR on one ticket with no self-transfer",
  },
  {
    date: "Nov 13",
    from: "Udaipur hotel",
    to: "City Palace / Jagdish Temple / Lake Pichola",
    mode: "Private local car + guide",
    category: "car",
    duration: "Flexible full day",
    status: "Local sightseeing",
    action: "Keep the lake day relaxed after the connecting flight",
  },
  {
    date: "Nov 14",
    from: "Udaipur hotel",
    to: "Jaipur hotel",
    mode: "Private guide-driven car",
    category: "car",
    duration: "About 6h30-7h plus stops",
    status: "Car faster door-to-door than current non-premium train",
    evidence: "https://www.trippy.com/distance/Udaipur-to-Jaipur",
    action: "Use a comfortable vehicle; leave the evening unscheduled",
  },
  {
    date: "Nov 15",
    from: "Jaipur hotel",
    to: "Amber Fort / City Palace / Hawa Mahal",
    mode: "Private local car + guide",
    category: "car",
    duration: "Flexible full day",
    status: "Local sightseeing",
    action: "Use one guide and driver; keep shopping optional",
  },
  {
    date: "Nov 16",
    from: "Jaipur hotel",
    ...
    status: "Car wins door-to-door; no faster premium train",
    evidence: "https://www.rome2rio.com/s/Jaipur/Agra",
    action: "Add Fatehpur Sikri only if the group wants the extra monument stop",
  },
  {
    date: "Nov 17",
    from: "Agra hotel",
    to: "Taj Mahal / Agra Fort",
    mode: "Private local car + guide",
    category: "car",
    duration: "Sunrise to mid-afternoon",
    status: "Taj open Tuesday; closed Friday only",
    evidence: "https://tajmahal.gov.in/",
    action: "Book first-entry Taj tickets and finish in time for Agra Cantt",
  },
  {
    date: "Nov 17",
    from: "Agra Cantt (AGC)",
    to: "Delhi Hazrat Nizamuddin (NZM)",
    mode: "Gatimaan Express 12049",
    category: "train",
    duration: "Current timetable about 1h55, 17:35-19:30",
    status: "Premium train substantially faster than car",
    evidence: "https://erail.in/train-enquiry/12049",
    action: "Book Executive Chair Car when reservations open",
  },
  {
    date: "Nov 18",
    from: "Delhi hotel",
    to: "Humayun's Tomb / selected Old and New Delhi",
    mode: "Private local car + guide",
    category: "car",
    duration: "Morning to about 15:30",
    status: "Wednesday avoids Monday closures",
    action: "Keep the day focused and leave early for Anand Vihar Terminal",
  },
  {
    date: "Nov 18",
    from: "Anand Vihar (ANVT)",
    to: "Haridwar (HW) then Rishikesh",
    mode: "Vande Bharat 22457 + private car",
    category: "train",
    duration: "17:50-21:11 train + about 45-60m by car",
    status: "Premium train faster than driving",
    evidence: "https://erail.in/train-enquiry/22457",
    action: "Book Executive Chair Car and pre-arrange the Haridwar-Rishikesh transfer",
  },
  {
    date: "Nov 19",
    from: "Rishikesh hotel",
    to: "Ganga riverfront / Beatles Ashram",
    mode: "Local guide + car/walk",
    category: "car",
    duration: "Flexible",
    status: "Gentle local day",
    action: "Keep the pace light and reserve Aarti support if wanted",
  },
  {
    date: "Nov 20",
    from: "Rishikesh hotel via Dehradun (DED)",
    to: "Mumbai (BOM)",
    mode: "Private airport car + direct flight",
    category: "flight-direct",
    duration: "Road 30-60m + direct flight about 2h35",
    status: "Direct flight; winter schedule to confirm",
    evidence: "https://www.airindia.com/en-in/book-flights/dehradun-to-mumbai-flights",
    action: "Book BOM, not Navi Mumbai (NMI), and protect the final Mumbai buffer",
  },
  {
    date: "Nov 21",
    from: "Mumbai (BOM)",
    to: "Dublin (DUB) via Doha",
    mode: "Booked flights 6E1303 + QR17",
    category: "flight-connection",
    duration: "4h05 + 3h15 layover + 7h30",
    status: "Booked",
    action: "Follow the terminals and check-in guidance on the booking",
  },
];
...
export const agencyTasks: AgencyTask[] = [
  { date: "Nov 9", city: "Mumbai", pickup: "BOM airport", dropoff: "Mumbai hotel", service: "Arrival transfer", category: "taxi", duration: "45-90m", action: "Private meet-and-greet for QR556 arrival at 02:35" },
  { date: "Nov 10", city: "Mumbai", pickup: "Mumbai hotel", dropoff: "Gateway / Colaba", service: "Optional private local car", category: "optional", duration: "Short morning", action: "Keep optional before the train", optional: true },
  { date: "Nov 10", city: "Mumbai", pickup: "Mumbai hotel", dropoff: "CSMT station", service: "Private station transfer", category: "taxi", duration: "45-90m", action: "Protect a generous traffic buffer before Vande Bharat 20706" },
  { date: "Nov 11", city: "Aurangabad", pickup: "Aurangabad hotel", dropoff: "Ellora return", service: "Private car + Ellora guide", category: "vip", duration: "Full day", action: "Book guide focused on Kailasa Temple; Wednesday is open (weekly closure Tuesday)" },
  { date: "Nov 12", city: "Aurangabad", pickup: "Aurangabad hotel", dropoff: "IXU airport", service: "Private airport transfer", category: "taxi", duration: "20-40m", action: "Coordinate with the confirmed one-ticket IXU -> BOM -> UDR itinerary" },
  { date: "Nov 13", city: "Udaipur", pickup: "Udaipur hotel", dropoff: "City Palace / Lake Pichola", service: "Guide + optional boat support", category: "vip", duration: "Full day", action: "Book City Palace guide; boat if weather works" },
  { date: "Nov 14", city: "Udaipur / Jaipur", pickup: "Udaipur hotel", dropoff: "Jaipur hotel", service: "Private guide-driven car", category: "car", duration: "6h30-7h with stops", action: "Use a comfortable vehicle; car is faster door-to-door than the current train" },
  { date: "Nov 15", city: "Jaipur", pickup: "Jaipur hotel", dropoff: "Amber Fort / City Palace", service: "Private car + palace/fort guide", category: "vip", duration: "Full day", action: "Book Amber Fort and City Palace support" },
  { date: "Nov 16", city: "Jaipur / Agra", pickup: "Jaipur hotel", dropoff: "Agra hotel", service: "Private guide-driven car", category: "car", duration: "4h direct; 5-6h via Fatehpur Sikri", action: "Keep Fatehpur Sikri optional and use the direct route otherwise" },
  { date: "Nov 17", city: "Agra", pickup: "Agra hotel", dropoff: "Taj Mahal / Agra Fort", service: "Taj sunrise VIP/guide/tickets", category: "vip", duration: "Morning to mid-afternoon", action: "Book first-entry Tuesday guide and required tickets" },
  { date: "Nov 17", city: "Agra", pickup: "Agra hotel", dropoff: "Agra Cantt station", service: "Private station transfer", category: "taxi", duration: "20-40m", action: "Protect the 17:35 Gatimaan Express" },
  { date: "Nov 17", city: "Delhi", pickup: "Hazrat Nizamuddin station", dropoff: "Delhi hotel", service: "Private arrival transfer", category: "taxi", duration: "30-75m", action: "Driver to meet the Gatimaan arrival" },
  { date: "Nov 18", city: "Delhi", pickup: "Delhi hotel", dropoff: "Humayun's Tomb / selected Old and New Delhi", service: "Private car + Delhi guide", category: "vip", duration: "Morning to 15:30", action: "Keep the visit focused before the train" },
  { date: "Nov 18", city: "Delhi", pickup: "Delhi sightseeing", dropoff: "Anand Vihar Terminal", service: "Private station transfer", category: "taxi", duration: "Traffic-dependent", action: "Reach ANVT early for Vande Bharat 22457" },
  { date: "Nov 18", city: "Haridwar / Rishikesh", pickup: "Haridwar station", dropoff: "Rishikesh hotel", service: "Private late-evening transfer", category: "taxi", duration: "45-60m", action: "Pre-arrange driver for the 21:11 train arrival" },
  { date: "Nov 19", city: "Rishikesh", pickup: "Rishikesh hotel", dropoff: "Beatles Ashram / Ganga Aarti", service: "Local guide or reserved viewing support", category: "vip", duration: "Half day / evening", action: "Keep gentle and scenic" },
  { date: "Nov 20", city: "Rishikesh / Dehradun", pickup: "Rishikesh hotel", dropoff: "DED airport", service: "Private airport transfer", category: "taxi", duration: "30-60m", action: "Coordinate with a direct DED -> BOM flight; do not use NMI" },
  { date: "Nov 20 / 21", city: "Mumbai", pickup: "BOM airport", dropoff: "Mumbai hotel, then BOM airport", service: "Arrival and departure transfers", category: "taxi", duration: "45-90m each", action: "Protect the hotel buffer and leave around midnight for 6E1303" },
];
...
const deeperContextNotes: Partial<Record<string, Record<Language, string>>> = {
  ...
  "delhi:Humayun's Tomb": {
    en: "Humayun's Tomb is the best Delhi introduction because it clarifies the visual language just seen at the Taj: garden axis, raised platform, red sandstone, white marble, water geometry and dynastic memory.\n\nIt also gives Delhi a calmer face. Rather than starting with traffic and crowds, the family begins with proportion, shade and a monument where the Mughal idea of paradise-garden architecture is easy to read.",
    it: "La Tomba di Humayun è la migliore introduzione a Delhi perché chiarisce il linguaggio visivo appena visto al Taj: asse del giardino, piattaforma rialzata, arenaria rossa, marmo bianco, geometria dell'acqua e memoria dinastica.\n\nMostra anche un volto più calmo di Delhi. Invece di iniziare da traffico e folla, la famiglia comincia con proporzione, ombra e un monumento in cui l'idea moghul del giardino-paradiso è facile da leggere.",
  },
  "delhi:Qutub Minar complex": {
  ...
  "rishikesh:Yoga / ashram time": {
    en: "Yoga or ashram time is what makes Rishikesh restorative rather than merely scenic. It connects the town's global identity with a practical need in the itinerary: slowing down after Delhi and before the final flight to Mumbai.\n\nThe best version is gentle and private. It should leave everyone calmer, not tired, and it should be booked for comfort rather than intensity.",
    it: "Yoga o tempo in ashram è ciò che rende Rishikesh rigenerante e non solo panoramica. Collega l'identità globale della città a una necessità pratica dell'itinerario: rallentare dopo Delhi e prima del volo finale per Mumbai.\n\nLa versione migliore è leggera e privata. Deve lasciare tutti più calmi, non più stanchi, e va prenotata per comfort, non per intensità.",
  },
  "rishikesh:Ganga Aarti": {
  ...
  "udaipur:Lake Pichola": {
    en: "Lake Pichola is the scenic structure of Udaipur. It organizes palaces, ghats, islands, hills and evening light into the image people remember from the city.\n\nA boat ride or lakeside dinner is not filler; it is the right way to understand why Udaipur is on the itinerary. The lake should slow the trip down before the guide drive to Jaipur.",
    it: "Lake Pichola è la struttura scenica di Udaipur. Organizza palazzi, ghat, isole, colline e luce serale nell'immagine che si ricorda della città.\n\nUn giro in barca o una cena sul lago non è riempitivo: è il modo giusto per capire perché Udaipur è nell'itinerario. Il lago deve rallentare il viaggio prima del trasferimento in auto verso Jaipur.",
  },
  "udaipur:Jagdish Temple / old city lanes": {
