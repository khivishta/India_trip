...
export const staySummaries: StaySummary[] = [
  ...
  { city: "Agra", checkIn: "Nov 12", checkOut: "Nov 14", nights: 2, color: "#b91c1c" },
  { city: "Rishikesh", checkIn: "Nov 14", checkOut: "Nov 16", nights: 2, color: "#19734f" },
  { city: "Jaipur", checkIn: "Nov 16", checkOut: "Nov 18", nights: 2, color: "#be185d" },
  { city: "Udaipur", checkIn: "Nov 18", checkOut: "Nov 20", nights: 2, color: "#1d4ed8" },
...
const staySummariesIt: StaySummary[] = [
  ...
  { city: "Agra", checkIn: "12 nov", checkOut: "14 nov", nights: 2, color: "#b91c1c" },
  { city: "Rishikesh", checkIn: "14 nov", checkOut: "16 nov", nights: 2, color: "#19734f" },
  { city: "Jaipur", checkIn: "16 nov", checkOut: "18 nov", nights: 2, color: "#be185d" },
  { city: "Udaipur", checkIn: "18 nov", checkOut: "20 nov", nights: 2, color: "#1d4ed8" },
...
export const mustSeeByDate: Record<string, string> = {
  ...
  "Nov 12, 2026": "One-stop flight to Agra; no added city stop",
  "Nov 13, 2026": "Agra Fort, Itimad-ud-Daulah, Mehtab Bagh — Taj closed Friday",
  "Nov 14, 2026": "Taj Mahal sunrise, then guide drive to Rishikesh",
  "Nov 15, 2026": "Ganga riverfront, Beatles Ashram, slow mountain/river day",
  "Nov 16, 2026": "Guide drive to Jaipur",
  "Nov 17, 2026": "Amber Fort, City Palace, Hawa Mahal",
  "Nov 18, 2026": "Guide drive to Udaipur",
  "Nov 19, 2026": "City Palace, Lake Pichola, Jagdish Temple",
  "Nov 20, 2026": "Direct flight UDR -> BOM, protected departure buffer",
...
export const mustSeeByDateIt: Record<string, string> = {
  ...
  "12 novembre 2026": "Volo con una coincidenza per Agra; nessuna città aggiunta",
  "13 novembre 2026": "Agra Fort, Itimad-ud-Daulah, Mehtab Bagh — Taj chiuso venerdì",
  "14 novembre 2026": "Taj Mahal all'alba, poi viaggio con guida fino a Rishikesh",
  "15 novembre 2026": "Ganga, Beatles Ashram, giornata lenta fiume/montagna",
  "16 novembre 2026": "Viaggio con guida fino a Jaipur",
  "17 novembre 2026": "Amber Fort, City Palace, Hawa Mahal",
  "18 novembre 2026": "Viaggio con guida fino a Udaipur",
  "19 novembre 2026": "City Palace, Lake Pichola, Jagdish Temple",
  "20 novembre 2026": "Volo senza scalo UDR -> BOM, cuscinetto partenza protetto",
...
export const transportSegments: TransportSegment[] = [
  ...
  },
  {
    ...
    category: "flight-connection",
    duration: "Current examples about 5h25-6h15",
    status: "No nonstop service currently shown",
    evidence: "https://www.ixigo.com/cheap-flights/aurangabad-agra-ixu-agr",
    action: "Confirm the Nov 12 schedule; book one ticket with no capital-city routing",
  },
  {
    date: "Nov 13",
    from: "Agra",
    to: "Agra Fort / Itimad-ud-Daulah / Mehtab Bagh",
    mode: "Private local car + guide",
    category: "car",
    duration: "Flexible full day",
    status: "Local sightseeing",
    action: "Keep the Friday plan outside the Taj Mahal, which is closed to tourists",
  },
  {
    date: "Nov 14",
    from: "Agra hotel via Taj Mahal",
    to: "Rishikesh hotel",
    mode: "Private guide-driven car",
    category: "car",
    duration: "Sunrise visit, then about 6-7h driving plus stops",
    status: "Taj open Saturday; long travel day",
    evidence: "https://www.coveringindia.com/en/distance-calculator/agra-to-rishikesh",
    action: "Start early; use a comfortable vehicle and planned breaks",
  },
  {
    date: "Nov 15",
  ...
  },
  {
    ...
    mode: "Private guide-driven car",
    category: "car",
    duration: "About 7-8h with stops",
    status: "Longest planned drive",
    evidence: "https://www.rome2rio.com/s/Rishikesh/Jaipur",
    action: "Start early; do not add sightseeing on arrival",
  },
  {
    date: "Nov 17",
    from: "Jaipur",
    ...
    duration: "Flexible full day",
    status: "Local sightseeing",
    action: "Use one guide and driver for the full day",
  },
  {
    date: "Nov 18",
    from: "Jaipur hotel",
    ...
    mode: "Private guide-driven car",
    category: "car",
    duration: "About 6-7h with stops",
    status: "Within the drive limit",
    action: "Start after breakfast and schedule a comfortable lunch stop",
  },
  {
    date: "Nov 20",
    from: "Udaipur (UDR)",
    ...
    evidence: "https://www.goindigo.in/airport-directory/india/udaipur-udr.html",
...
const transportSegmentsIt: TransportSegment[] = transportSegments.map((segment, index) => {
  const translations = [
    ...
    ["Volo con una coincidenza", "Nessun volo senza scalo attualmente indicato", "Confermare il 12 novembre; un solo biglietto senza passare dalla capitale"],
    ["Auto locale privata + guida", "Visite locali", "Prenotare guida all'alba e biglietti Taj"],
    ["Auto privata con guida", "Entro il limite di guida", "Partire presto con veicolo comodo e pause pianificate"],
    ["Guida locale + auto/a piedi", "Giornata locale leggera", "Ritmo lento e supporto Aarti se desiderato"],
    ["Auto privata con guida", "Viaggio in auto piu lungo", "Partire presto; nessuna visita all'arrivo"],
    ["Auto locale privata + guida", "Visite locali", "Usare la stessa guida e lo stesso autista tutto il giorno"],
    ["Auto privata con guida", "Entro il limite di guida", "Partire dopo colazione con una pausa pranzo comoda"],
  ...
  return {
    ...segment,
    date: ["8 nov", "9 nov", "10 nov", "10 nov", "11 nov", "12 nov", "12 nov", "13 nov", "14 nov", "15 nov", "16 nov", "17 nov", "18 nov", "20 nov", "21 nov"][index],
    mode: translations[0],
...
export const agencyTasks: AgencyTask[] = [
  ...
  { date: "Nov 11 or buffer", city: "Aurangabad", pickup: "Aurangabad hotel", dropoff: "Ajanta return", service: "Ajanta Caves car + guide", category: "optional", duration: "Long full day, about 2.5h each way", action: "Optional only; the short itinerary does not include it", optional: true },
  { date: "Nov 12", city: "Aurangabad", pickup: "Aurangabad hotel", dropoff: "IXU airport", service: "Private airport transfer", category: "taxi", duration: "20-40m", action: "Coordinate with the confirmed IXU -> AGR itinerary" },
  { date: "Nov 13", city: "Agra", pickup: "Agra hotel", dropoff: "Agra Fort / Itimad-ud-Daulah / Mehtab Bagh", service: "Private local car + guide", category: "vip", duration: "Flexible day", action: "Taj Mahal is closed Friday; visit the other open monuments" },
  { date: "Nov 14", city: "Agra", pickup: "Agra hotel", dropoff: "Taj Mahal", service: "Taj sunrise VIP/guide/tickets", category: "vip", duration: "Early morning", action: "Book first-entry Saturday guide and required tickets" },
  { date: "Nov 14", city: "Agra / Rishikesh", pickup: "Agra hotel after the Taj", dropoff: "Rishikesh hotel", service: "Private guide-driven car", category: "car", duration: "6-7h plus stops", action: "Use a comfortable vehicle and leave directly after breakfast/check-out" },
  { date: "Nov 15", city: "Rishikesh", pickup: "Rishikesh hotel", dropoff: "Beatles Ashram / Ganga Aarti", service: "Local guide or reserved viewing support", category: "vip", duration: "Half day / evening", action: "Keep gentle and scenic" },
  { date: "Nov 16", city: "Rishikesh / Jaipur", pickup: "Rishikesh hotel", dropoff: "Jaipur hotel", service: "Private guide-driven car", category: "car", duration: "7-8h with stops", action: "Start early; no touring after arrival" },
  { date: "Nov 17", city: "Jaipur", pickup: "Jaipur hotel", dropoff: "Amber Fort / City Palace", service: "Private car + palace/fort guide", category: "vip", duration: "Full day", action: "Book Amber Fort and City Palace support" },
  { date: "Nov 18", city: "Jaipur / Udaipur", pickup: "Jaipur hotel", dropoff: "Udaipur hotel", service: "Private guide-driven car", category: "car", duration: "6-7h with stops", action: "Plan a comfortable lunch break" },
  { date: "Nov 19", city: "Udaipur", pickup: "Udaipur hotel", dropoff: "City Palace / Lake Pichola", service: "Guide + optional boat support", category: "vip", duration: "Full day", action: "Book City Palace guide; boat if weather works" },
  { date: "Nov 20", city: "Udaipur", pickup: "Udaipur hotel", dropoff: "UDR airport", service: "Private airport transfer", category: "taxi", duration: "30-45m", action: "Coordinate with the nonstop UDR -> BOM flight" },
...
const agencyTasksIt: AgencyTask[] = agencyTasks.map((task, index) => {
  const translations = [
    ...
    ["11 nov", "Auto privata + guida Ellora", "Prenotare guida focalizzata sul Tempio Kailasa"],
    ["11 nov o cuscinetto", "Auto + guida Grotte di Ajanta", "Solo opzionale; non inclusa nell'itinerario breve"],
    ["12 nov", "Trasferimento privato aeroporto", "Coordinare con l'itinerario IXU -> AGR confermato"],
    ["13 nov", "Taj all'alba VIP/guida/biglietti", "Prenotare guida all'alba e biglietti richiesti"],
    ["13 nov", "Auto locale privata + guida", "Usare la stessa guida dopo la pausa colazione post-Taj"],
    ["14 nov", "Auto privata con guida", "Usare veicolo comodo; partire presto"],
    ["15 nov", "Guida locale o supporto Aarti", "Tenere scenico e leggero"],
    ["16 nov", "Auto privata con guida", "Partire presto; nessuna visita dopo l'arrivo"],
    ["17 nov", "Auto privata + guida forte/palazzo", "Prenotare supporto Amber Fort e City Palace"],
    ["18 nov", "Auto privata con guida", "Pianificare una pausa pranzo comoda"],
    ["19 nov", "Guida + supporto barca opzionale", "Prenotare guida City Palace; barca se il meteo va bene"],
    ["20 nov", "Trasferimento privato aeroporto", "Coordinare con il volo senza scalo UDR -> BOM"],
