...
export const staySummaries: StaySummary[] = [
  ...
  { city: "Delhi", checkIn: "Nov 12", checkOut: "Nov 13", nights: 1, color: "#7c2d12" },
  { city: "Agra", checkIn: "Nov 13", checkOut: "Nov 14", nights: 1, color: "#b91c1c" },
  { city: "Jaipur", checkIn: "Nov 14", checkOut: "Nov 16", nights: 2, color: "#be185d" },
  { city: "Rishikesh", checkIn: "Nov 16", checkOut: "Nov 18", nights: 2, color: "#19734f" },
...
const staySummariesIt: StaySummary[] = [
  ...
  { city: "Delhi", checkIn: "12 nov", checkOut: "13 nov", nights: 1, color: "#7c2d12" },
  { city: "Agra", checkIn: "13 nov", checkOut: "14 nov", nights: 1, color: "#b91c1c" },
  { city: "Jaipur", checkIn: "14 nov", checkOut: "16 nov", nights: 2, color: "#be185d" },
  { city: "Rishikesh", checkIn: "16 nov", checkOut: "18 nov", nights: 2, color: "#19734f" },
...
export const mustSeeByDate: Record<string, string> = {
  ...
  "Nov 10, 2026": "Optional Gateway of India / Colaba, then flight to Aurangabad",
  "Nov 11, 2026": "Ellora Caves, Kailasa Temple",
  "Nov 12, 2026": "Flight to Delhi, India Gate drive-by",
  "Nov 13, 2026": "Humayun's Tomb or Lodhi Garden, then Agra transfer",
  "Nov 14, 2026": "Taj Mahal sunrise, Jaipur arrival",
  "Nov 15, 2026": "Amber Fort, City Palace, Hawa Mahal",
  "Nov 16, 2026": "Connected flight to Dehradun, taxi to Rishikesh",
  "Nov 17, 2026": "Ganga riverfront, Beatles Ashram, slow mountain/river day",
  "Nov 18, 2026": "Rishikesh morning, connected flight toward Udaipur",
...
export const mustSeeByDateIt: Record<string, string> = {
  ...
  "10 novembre 2026": "Gateway of India / Colaba opzionali, poi volo per Aurangabad",
  "11 novembre 2026": "Grotte di Ellora, Tempio Kailasa",
  "12 novembre 2026": "Volo per Delhi, India Gate in auto",
  "13 novembre 2026": "Tomba di Humayun o Lodhi Garden, poi trasferimento ad Agra",
  "14 novembre 2026": "Taj Mahal all'alba, arrivo a Jaipur",
  "15 novembre 2026": "Amber Fort, City Palace, Hawa Mahal",
  "16 novembre 2026": "Volo con coincidenza per Dehradun, taxi per Rishikesh",
  "17 novembre 2026": "Ganga, Beatles Ashram, giornata lenta fiume/montagna",
  "18 novembre 2026": "Mattina a Rishikesh, volo con coincidenza verso Udaipur",
...
export const transportSegments: TransportSegment[] = [
  ...
  },
  {
    ...
    evidence: "https://www.goindigo.in/domestic-flights/mumbai-to-aurangabad-flights.html",
  ...
  },
  {
    ...
    status: "Nonstop evidence",
    evidence: "https://www.goindigo.in/airport-directory/india/aurangabad-ixu.html",
    action: "Book nonstop only",
  },
  {
    date: "Nov 13",
  ...
  },
  {
    ...
    category: "flight-connection",
    duration: "Fastest current option about 6h20m",
    status: "No direct IndiGo service currently listed",
    evidence: "https://www.goindigo.in/domestic-flights/jaipur-to-dehradun-flights.html",
  ...
  },
  {
    ...
    evidence: "https://www.goindigo.in/domestic-flights/dehradun-to-udaipur-flights.html",
    action: "Book only a clean same-ticket connection",
  },
  {
    date: "Nov 19",
  ...
  },
  {
    ...
    action: "Leave around midnight for the 03:15 departure",
  },
  {
    date: "Nov 21",
    from: "Mumbai (BOM)",
...
const transportSegmentsIt: TransportSegment[] = transportSegments.map((segment, index) => {
  const translations = [
    ...
    ["Volo con coincidenza", "Nessun volo IndiGo diretto attualmente indicato", "Prenotare solo una coincidenza pulita sullo stesso biglietto"],
  ...
  return {
    ...segment,
    date: ["8 nov", "9 nov", "10 nov", "11 nov", "12 nov", "13 nov", "14 nov", "16 nov", "16 nov", "18 nov", "18 nov", "19 nov", "20 nov", "20 nov", "21 nov"][index],
    mode: translations[0],
...
export const agencyTasks: AgencyTask[] = [
  ...
  { date: "Nov 10", city: "Mumbai", pickup: "Mumbai hotel", dropoff: "Gateway / Colaba", service: "Optional private local car", category: "optional", duration: "Short morning", action: "Keep optional before the domestic flight", optional: true },
  ...
  { date: "Nov 13", city: "Delhi", pickup: "Delhi hotel", dropoff: "Humayun's Tomb or Lodhi Garden", service: "Private local car", category: "vip", duration: "Short morning", action: "Choose one focused stop before Agra" },
  { date: "Nov 13", city: "Delhi / Agra", pickup: "Delhi hotel", dropoff: "Agra hotel", service: "Private intercity car", category: "car", duration: "3-4h", action: "Book comfortable car with luggage space" },
  { date: "Nov 14", city: "Agra", pickup: "Agra hotel", dropoff: "Taj Mahal", service: "Taj sunrise VIP/guide/tickets", category: "vip", duration: "Early morning", action: "Book sunrise guide and required tickets" },
  { date: "Nov 14", city: "Agra / Jaipur", pickup: "Agra hotel", dropoff: "Jaipur hotel", service: "Private intercity car", category: "car", duration: "4-5h", action: "Schedule after Taj breakfast" },
  ...
  { date: "Nov 16", city: "Rishikesh", pickup: "DED airport", dropoff: "Rishikesh hotel", service: "Airport taxi transfer", category: "taxi", duration: "45-60m", action: "Driver meets the connected JAI -> DED itinerary" },
  { date: "Nov 17", city: "Rishikesh", pickup: "Rishikesh hotel", dropoff: "Ganga Aarti / Beatles Ashram", service: "Local guide or reserved viewing support", category: "vip", duration: "Half day / evening", action: "Keep gentle and scenic" },
  { date: "Nov 18", city: "Rishikesh", pickup: "Rishikesh hotel", dropoff: "DED airport", service: "Airport taxi transfer", category: "taxi", duration: "45-60m", action: "Build in buffer for connected flight" },
  ...
  { date: "Nov 20", city: "Mumbai", pickup: "Mumbai hotel", dropoff: "BOM airport", service: "Departure transfer", category: "taxi", duration: "45-90m", action: "Leave around midnight for the 03:15 departure" },
];

const agencyTasksIt: AgencyTask[] = [
  { ...agencyTasks[0], date: "9 nov", service: "Trasferimento arrivo", action: "Accoglienza privata per QR556 in arrivo alle 02:35" },
  { ...agencyTasks[1], date: "10 nov", service: "Auto locale privata opzionale", duration: "Mattina breve", action: "Tenere opzionale prima del volo domestico" },
  { ...agencyTasks[2], date: "11 nov", service: "Auto privata + guida Ellora", duration: "Giornata intera", action: "Prenotare guida focalizzata sul Tempio Kailasa" },
  { ...agencyTasks[3], date: "11 nov o cuscinetto", service: "Auto + guida Grotte di Ajanta", duration: "Giornata intera lunga, circa 2,5h per tratta", action: "Solo opzionale; non inclusa nell'itinerario breve" },
  { ...agencyTasks[4], date: "13 nov", dropoff: "Tomba di Humayun o Lodhi Garden", service: "Auto locale privata", duration: "Mattina breve", action: "Scegliere una sola tappa prima di Agra" },
  { ...agencyTasks[5], date: "13 nov", service: "Auto privata intercity", action: "Prenotare auto comoda con spazio bagagli" },
  { ...agencyTasks[6], date: "14 nov", service: "Taj all'alba VIP/guida/biglietti", duration: "Mattina presto", action: "Prenotare guida all'alba e biglietti richiesti" },
  { ...agencyTasks[7], date: "14 nov", service: "Auto privata intercity", action: "Programmare dopo colazione post-Taj" },
  { ...agencyTasks[8], date: "15 nov", service: "Auto privata + guida forte/palazzo", duration: "Giornata intera", action: "Prenotare supporto Amber Fort e City Palace" },
  { ...agencyTasks[9], date: "16 nov", service: "Taxi aeroporto", action: "Autista incontra l'itinerario JAI -> DED con coincidenza" },
  { ...agencyTasks[10], date: "17 nov", service: "Guida locale o supporto vista Aarti", duration: "Mezza giornata / sera", action: "Tenere scenico e leggero" },
  { ...agencyTasks[11], date: "18 nov", service: "Taxi aeroporto", action: "Aggiungere margine per il volo con coincidenza" },
  { ...agencyTasks[12], date: "19 nov", service: "Guida + supporto barca opzionale", duration: "Giornata intera", action: "Prenotare guida City Palace; barca se il meteo va bene" },
  { ...agencyTasks[13], date: "20 nov", service: "Trasferimento partenza", action: "Partire verso mezzanotte per il volo delle 03:15" },
];
